...
public interface AppComponentsBuilder {
    ...
    AppWorkspaceComponent buildWorkspaceComponentlvlsel(String gameMode) throws Exception;

    AppWorkspaceComponent buildWorkspaceComponentGamePlay(String gameMode, int difficulty) throws Exception;
}
